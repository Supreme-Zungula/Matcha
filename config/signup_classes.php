...
function email_concat($enter_key, $otp){
    ...
    $mid = "\nor ";
    $hype_link = "http://127.0.0.1:8080/matcha/index_php_files/link_Verify.php?enter_key=".$enter_key."&otp=".$otp;
...
function forgot_password_email_concat($enter_key, $otp){
    ...
    $hype_link = "http://127.0.0.1:8080/matcha/index_php_files/forgot_password.php?enter_key=".$enter_key."&otp=".$otp;
    return (wordwrap($head.$mid.$hype_link));
}
